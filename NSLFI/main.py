...
nreSettings.simulatedObservations = True
...
posterior = swyft.MarginalPosterior(mre_3d, prior)
weighted_samples_3d = posterior.weighted_sample(n_weighted_samples, x_0)
...
data = weighted_samples_3d.get_df(trained_nre.marginal_indices_3d)
